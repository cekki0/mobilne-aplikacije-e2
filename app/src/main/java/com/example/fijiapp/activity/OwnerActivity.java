...
public class OwnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users.add(new User("user1@example.com", "password1", "John", "Doe", "123 Main St", "1234567890", "https://picsum.photos/400", UserRole.STAFF));
        users.add(new User("user2@example.com", "password2", "Jane", "Smith", "456 Elm St", "0987654321", "https://picsum.photos/600", UserRole.STAFF));
        users.add(new User("user3@example.com", "password3", "Alice", "Johnson", "789 Oak St", "9876543210", "https://picsum.photos/800", UserRole.STAFF));
